...
@Entity(name = "distance_pick_up_point")
@Table(name = "distance_pick_up_point", schema = "biztrip_database", catalog = "")
public class PickUpPointEntity {
    ...
    public PickUpPointEntity(String createdAt, int date, int day,  long distanceId,boolean isDefault, long locationId, String status,String  time, String  updatedAt) {
